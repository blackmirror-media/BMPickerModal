...
UIPickerViewDelegate {
  ...
  // Buttons text color
  public var buttonsColor: UIColor = UIColor.blue
  ...
  override public func viewWillAppear(_ animated: Bool) {
    ...
    let cancelButton: UIButton = UIButton(type: UIButton.ButtonType.system)
    cancelButton.setTitle(self.cancelButtonTitle, for: UIControl.State())
    cancelButton.frame = CGRect(x: 5, y: 5, width: 100, height: 30);
    cancelButton.setTitleColor(self.buttonsColor, for: .normal)
    ...
    let saveButton: UIButton = UIButton(type: UIButton.ButtonType.system)
    saveButton.setTitle(self.saveButtonTitle, for: UIControl.State())
    ...
    saveButton.setTitleColor(buttonsColor, for: .normal)
